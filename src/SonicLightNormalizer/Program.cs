...
namespace SonicLightNormalizer
{
    ...
    public class Program
    {
        ...
        public static void Main(string[] args)
        {
            ...
            {
                Console.WriteLine("SonicLightNormalizer.\n");
                Console.WriteLine("Sonic Forces to Sonic Unleashed/Gens/LW .light converter.");
                Console.WriteLine("Made by SWS90 with help from Sajid\n");
                Console.WriteLine("Takes Any .light file and divides the RGB color by 10,000");
                Console.WriteLine("");
                Console.WriteLine("Usage: Drag and drop any .light file to divide the RGB color by 10,000\nOr a folder with .light files to convert multiple files.");
            }
            Console.WriteLine("");
